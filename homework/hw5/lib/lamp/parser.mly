...
%token CLET CPRINT CCLEAR CLOAD CSAVE CPLUSMETA CMINUSMETA CSYNTH
%token TICK FORALL
...
ty:
    | ty; THINARROW; ty { TFun ($1, $3) }
    | TYLIST LBRACK ty RBRACK { TList $3 }
    | ty_atom { $1 }
    | ty; TIMES; ty { TProd ($1, $3) }

// pty:
//     | ty { Mono $1 }
//     | FORALL ty_vars DOT ty { Forall (Vars.of_list $2, $4)}
